            ...
            <div className={`max-w-6xl mx-auto flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12 md:gap-20`}>
                ...
                >
                    <div className="relative group">
                        <div className="absolute -inset-2 bg-gradient-to-r from-[#FFA016] to-[#ff8c00] rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
                ...
                >
                    <div className="flex flex-col">
                        <div className="w-16 h-1 bg-[#FFA016] mb-6 rounded-full" />
                        <h2 className={`text-3xl md:text-5xl font-black uppercase tracking-tighter mb-2 ${theme === 'light' ? 'text-black' : 'text-white'}`}>
                            {name}
                        </h2>
                        <h3 className="text-[#FFA016] text-sm md:text-lg font-bold uppercase tracking-widest mb-8">
                            {title}
                        </h3>
