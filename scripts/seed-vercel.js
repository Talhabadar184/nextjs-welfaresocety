...
//                 .insertInto('events')
//                 .values(event)
//                 .onConflict((oc) => oc.column('slug'))
//                 .doUpdateSet({
//                     title: event.title,
//                     date: event.date,
//                     description: event.description,
//                     image: event.image,
//                     sub_images: event.sub_images,
...
//         process.exit(1);
//     } finally {
//         await db.destroy(); // only destroy once
//         // no need to call pool.end() separately
//     }
// }
...
async function seed() {
    ...
    try {
        ...
        await db.destroy(); // closes pool safely
    }
}
